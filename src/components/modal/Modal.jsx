...
class Modal extends Component {
  ...
  handleChangeForTimeStart=(e)=>{
    const validation= Number(convertStringToTime(e.target.value))> Number(convertStringToTime(this.state.endTime))||Number(convertStringToTime(e.target.value))=== Number(convertStringToTime(this.state.endTime));
    this.setState({
    ...
    const validation= Number(convertStringToTime(e.target.value)) < Number(convertStringToTime(this.state.startTime))||Number(convertStringToTime(e.target.value))=== Number(convertStringToTime(this.state.startTime));
     console.log(convertStringToTime(e.target.value) > convertStringToTime(this.state.startTime)||convertStringToTime(e.target.value)=== convertStringToTime(this.state.endTime))  
    this.setState({
      errorMessageTime: validation,
...
this.props.closeModal(e)}
        ...
        <div className="modal__content">
          <div className="create-event">
            ...
            >
              {this.state.errorMessageTitle?(<div className='error-message'>Title must be some info</div>):''}
              <input
                type="text"
                name="title"
                placeholder="Title"
              ...
              <div className="event-form__time">
                {this.state.errorMessageTime?(<div className='error-message'>Start time must be less than end time</div>):''}
                <input
                  type="date"
                  name="date"
                  className="event-form__field"
